...
/**
 * Scrap helm-release.yaml files, find subdomains and fetch them to ensure
 ...
 */
const check404 = async (s) => {
  const url = `https://${s}.${process.env.PUBLIC_DOMAIN}`
...
await Promise.resolve()
  ...
  .then(() => glob("../cluster/**/helm-release.yaml"))
